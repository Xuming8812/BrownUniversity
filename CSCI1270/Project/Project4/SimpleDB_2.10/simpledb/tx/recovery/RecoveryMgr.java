...
public class RecoveryMgr {
   ...
   /**
    * Writes a NQ checkpoint record to the log, and flushes it to disk.
    */
    public void checkpoint(HashSet<Integer> activeTransactions) {
      SimpleDB.bufferMgr().flushAll(txnum);
      int lsn = new NQCheckpoint(activeTransactions).writeToLog();
