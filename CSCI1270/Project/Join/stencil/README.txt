...
IV. Running Client Programs 
  ...
  The following list briefly describes the SimpleDB clients.
    ...
    * simpledb.clients.CreateStudentDB creates and populates the student database used
    ...
    * simpledb.clients.SQLInterpreter repeatedly prints a prompt asking you to enter a
    ...
    * ChangeMajor changes the student named Amy to be a drama major.  
      ...
      use simpledb.clients.SQLInterpreter to run update commands).
  ...
  we could execute the client programs as follows:
             ...
             > java simpledb.clients.CreateStudentDB
