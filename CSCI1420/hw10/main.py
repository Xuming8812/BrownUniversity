...
from models import relu, relu_derivative
...
def test_models(dataset, epochs, test_size=0.2):
    ...
    #plot learning rate for 1NN
    # learning_rates = np.logspace(-6,0,7)
    # train_loss = []
    # test_loss = []
    # for l in learning_rates:
    #     print(l)
    #     nnmodel.train(X_train_b, Y_train,learning_rate=l, epochs=epochs, print_loss=False)
    #     train_loss.append(nnmodel.average_loss(X_train_b, Y_train))
    #     test_loss.append(nnmodel.average_loss(X_test_b, Y_test))
    #     print('Average Training Loss:', nnmodel.average_loss(X_train_b, Y_train))
    #     print('Average Testing Loss:', nnmodel.average_loss(X_test_b, Y_test))
    # plt.plot(learning_rates, train_loss,label='train loss')
    # plt.plot(learning_rates, test_loss, label='test loss')
    # plt.xscale('log')
    # plt.legend()
    # plt.show()

    #plot num of epochs for 1NN
    # num_epochs = [i for i in range(2,20,2)]
    # train_loss = []
    # test_loss = []  
    # for n in num_epochs:
    #     print(n)
        
    #     nnmodel.train(X_train_b, Y_train, epochs=n, print_loss=False)
    #     train_loss.append(nnmodel.average_loss(X_train_b, Y_train))
    #     test_loss.append(nnmodel.average_loss(X_test_b, Y_test))
    #     print('Average Training Loss:', nnmodel.average_loss(X_train_b, Y_train))
    #     print('Average Testing Loss:', nnmodel.average_loss(X_test_b, Y_test))  
    ...
    #2NN hiddern layer size
    # paras = [i for i in range(2,20,2)]
    # train_loss = []
    # test_loss = [] 
    # for i in paras:
    #     print(i)
    #     model = TwoLayerNN(i)
    #     model.train(X_train, Y_train, epochs=epochs, print_loss=False)
    #     train_loss.append(model.average_loss(X_train, Y_train))
    #     test_loss.append(model.average_loss(X_test, Y_test))
    #     print('Average Training Loss:', model.average_loss(X_train, Y_train))
    #     print('Average Testing Loss:', model.average_loss(X_test, Y_test))

    # plt.plot(paras, train_loss,label='train loss')
    # plt.plot(paras, test_loss, label='test loss')
    # plt.legend()
    # plt.show()

    #2NN learning rate
    # paras = np.logspace(-6,0,7)
    # train_loss = []
    # test_loss = [] 
    # for i in paras:
    #     print(i)
    #     model = TwoLayerNN(10)
    #     model.train(X_train, Y_train, learning_rate=i, epochs=epochs, print_loss=False)
    #     train_loss.append(model.average_loss(X_train, Y_train))
    #     test_loss.append(model.average_loss(X_test, Y_test))
    #     print('Average Training Loss:', model.average_loss(X_train, Y_train))
    #     print('Average Testing Loss:', model.average_loss(X_test, Y_test))
    ...
    #     print(i)
    #     model = TwoLayerNN(10)
    #     model.train(X_train, Y_train, epochs=i, print_loss=False)
    #     train_loss.append(model.average_loss(X_train, Y_train))
    #     test_loss.append(model.average_loss(X_test, Y_test))
    #     print('Average Training Loss:', model.average_loss(X_train, Y_train))
    #     print('Average Testing Loss:', model.average_loss(X_test, Y_test))
